...
export class MultiAgentClient {
    ...
    initializeFunctionalityDatabase() {
        // Use comprehensive functionality database generated from all Python files
        const functionalities = MULTIAGENT_FUNCTIONALITIES;
        // Clear existing data
    ...
    async regenerateFunctionalityDatabase() {
        try {
    ...
    async getFunctionalityInfo(name, includeExamples = true) {
    ...
    async searchFunctionalities(query, category = "all", maxResults = 10) {
        const results = [];
    ...
    async getFunctionalitiesByFile(filename) {
        const functionalities = [];
        for (const [name, func] of this.functionalityDatabase) {
    ...
    async estimateSessionCount(agentCount, topology) {
    ...
    async generateWorkflowExample(agentCount, topology, useCase) {
        const setupSteps = [
...
//# sourceMappingURL=multiagent-client.js.map